...
void REMIXOS_Init(void)
{
    ...
    gpstrRootTaskTcb=REMIX_TaskCreate(ROOTTASKNAME, REMIX_BeforeRootTask, NULL, NULL, ROOTTASKSTACK, USERHIGHESTPRIORITY, NULL);
    gpstrIdleTaskTcb=REMIX_TaskCreate(ROOTIDLENAME, REMIX_IdleTask, NULL, NULL, IDLETASKSTACK, LOWESTPRIORITY, NULL);
...
void REMIX_TaskAddToReadyTable(REMIX_DLIST* pstrList, REMIX_DLIST* pstrNode, REMIX_PRIOFLAG* pstrPrioFlag, PRIORITYBITS ucTaskPrio)
{
    REMIX_TaskAddToSchedTable(pstrList, pstrNode, pstrPrioFlag, ucTaskPrio);
}

REMIX_DLIST* REMIX_TaskDeleteFromReadyTable(REMIX_DLIST* pstrList, REMIX_PRIOFLAG* pstrPrioFlag, PRIORITYBITS ucTaskPrio)
{
...
PRIORITYBITS REMIX_TaskGetHighestPrio(REMIX_PRIOFLAG* pstrPrioFlag)
{
    ...
    ucHighestFlagInGrp1=caucTaskPrioUnmapTab[pstrPrioFlag->aucPrioFlagGrp1[(ucPrioFlagGrp3*8+ucPrioFlagGrp2)*8+ucPrioFlagGrp1]];
