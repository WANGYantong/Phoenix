...
extern REMIX_DLIST* REMIX_TaskDeleteFromReadyTable(REMIX_DLIST * pstrList, REMIX_DLIST* pstrNode, REMIX_PRIOFLAG * pstrPrioFlag, PRIORITYBITS ucTaskPrio);
...
extern REMIX_DLIST* REMIX_TaskDeleteFromSchedTable(REMIX_DLIST * pstrList, REMIX_DLIST* pstrNode, REMIX_PRIOFLAG * pstrPrioFlag, PRIORITYBITS ucTaskPrio);
