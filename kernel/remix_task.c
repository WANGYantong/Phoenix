...
//*************************************************************************//
REMIX_TCB* REMIX_TaskCreate(U8* pucTaskName, VFUNCTION vfFucPointer, void* pvPara, U8* pucTaskStack, U32 uiStackSize, PRIORITYBITS ucTaskPrio, REMIX_TASKOPT* pstrTaskOpt)
{
    REMIX_TCB* pstrTcb;
    ...
    pstrTcb=REMIX_TaskTcbInit(pucTaskName, vfFucPointer, pvPara, pucTaskStack, uiStackSize, ucTaskPrio, pstrTaskOpt);
...
REMIX_TCB* REMIX_TaskTcbInit(U8* pucTaskName, VFUNCTION vfFucPionter, void* pvPara, U8* pucTaskStack, U32 uiStackSize, PRIORITYBITS ucTaskPrio, REMIX_TASKOPT* pstrTaskOpt)
{
    REMIX_TCB* pstrTcb;
